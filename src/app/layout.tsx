  ...
  return (
    <html lang="en" className={`${inter.variable} ${robotoMono.variable}`}>
      <body className="min-h-screen flex flex-col bg-sc-bg text-sc-text">
        <a href="#main" className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[200] focus:bg-sc-blue focus:text-white focus:px-4 focus:py-2 focus:rounded">
          Skip to content
        </a>
        <Navbar />
